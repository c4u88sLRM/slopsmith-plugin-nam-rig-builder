/* Aiden GT-550 UI — Eden WT-550 style gold/tan tube-preamp face: input jack,
...
static const Spot kKnobs[] = {
    ...
    { kP1Level, 0.460f, 0.66f, 0.030f, 0, "LOW" },
    { kP2Level, 0.560f, 0.66f, 0.030f, 0, "MID" },
    { kP3Level, 0.660f, 0.66f, 0.030f, 0, "HIGH" },
...
protected:
    ...
    void onNanoDisplay() override {
        ...
        text(bx+70*f,by+28*f,"Twin Triode Tube Pre Amplifier   GT-550",NULL);
