 ...
 *
 * Built from the Eden "BASS GUITAR PREAMP" factory schematic (David Eden,
 * 2-19-93, WT-300):
...
protected:
    ...
    const char* getDescription() const override { return "Eden WT-300 Valve-Tech bass preamp — component-level model"; }
